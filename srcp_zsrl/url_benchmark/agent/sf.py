...
class ICMS(FeatureLearner):
    ...
    def forward(self, obs: torch.Tensor, action: torch.Tensor, next_obs: torch.Tensor, future_obs: torch.Tensor):
        ...
        forward_error = (predicted_next_obs - next_target_phi.detach()).pow(2).mean()
...
class SFAgent:
    ...
    def __init__(self, **kwargs: tp.Any):
        ...
        learner = dict(icm=ICM, icms=ICMS, transition=TransitionModel, latent=TransitionLatentModel,
